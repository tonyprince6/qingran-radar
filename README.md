...
“热门话题”默认使用“24h 增长”排序：有历史互动快照时显示实测加权互动增长/小时；首轮缺少历史时，仅对近 24 小时发布的视频使用发布以来平均互动速度并标记为“估算”。

自动化分为三层：每 4 小时发现新话题并合并保留最近 24 小时样本；每 1 小时只为榜单前 10 名补全可靠视频链接；每 20 分钟刷新前 15 条已跟踪视频的点赞、评论、收藏、分享和互动历史。连续 3 次无法匹配的链接暂停 24 小时后再试。
